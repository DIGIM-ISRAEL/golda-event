...
// ברכה לליד טרי מעמוד "לידים נכנסים" — לפני שיש פרטי אירוע/מחיר.
// {שם} מתמלא משם הליד (אם יש); שאר המשתנים לא רלוונטיים בשלב הזה.
export const INCOMING_GREETING =
  'שלום {שם}! 🍦\nמדברים מגולדה אירועים — שמחנו לקבל את פנייתך ונשמח לעזור.\nמתי האירוע ולכמה אנשים? נכין לך הצעה משתלמת ומתוקה. 😊'
